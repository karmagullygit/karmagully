          ...
          children: [
            ...
            Column(
              children: [
                ...
                _buildManagementTile(
                  'Customer Management',
                  'Comprehensive customer analytics, orders & engagement',
                  Icons.people_alt,
                  Colors.blue,
                ...
                _buildManagementTile(
                  'Social Media Links',
                  'Manage social media links displayed in profile',
                  Icons.share,
                  const Color(0xFF8B5CF6),
                  () => Navigator.pushNamed(context, '/admin-social-media'),
                ),
                const SizedBox(height: 12),
                _buildManagementTile(
                  'Video Ads',
                ...
                _buildManagementTile(
                  '🤖 KarmaBot',
                  'Auto-post products to feed with AI captions',
                  Icons.smart_toy,
                  const Color(0xFF10B981),
                  () => Navigator.pushNamed(context, '/admin-bot-settings'),
                ),
                const SizedBox(height: 12),
                _buildManagementTile(
                  '🏆 KarmaGully Official',
                  'Post announcements, reels, stories & promotions',
                  Icons.verified,
                  const Color(0xFF9333EA),
                  () => Navigator.pushNamed(context, '/admin-official-bot'),
                ),
                const SizedBox(height: 12),
                _buildManagementTile(
                  '📢 Promotional Banners',
                  'Create sale banners for search & category pages',
                  Icons.campaign,
                  const Color(0xFFFF6B6B),
                  () => Navigator.pushNamed(context, '/admin-promotional-banners'),
                ),
                const SizedBox(height: 12),
                _buildManagementTile(
                  '🎨 Anime Poster Bot',
                  'Auto-generate & upload anime metal posters',
                  Icons.auto_awesome,
                  const Color(0xFFFF6B9D),
                  () => Navigator.pushNamed(context, '/admin-anime-poster-bot'),
                ),
                const SizedBox(height: 12),
                _buildManagementTile(
                  'Coupons & Discounts',
                ...
                _buildManagementTile(
                  '⚡ Flash Sales',
                  'Create and manage flash sales with timers',
                  Icons.flash_on,
                  Colors.red,
